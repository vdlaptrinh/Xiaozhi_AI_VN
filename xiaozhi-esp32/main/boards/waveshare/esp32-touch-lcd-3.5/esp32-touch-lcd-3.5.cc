...
class WaveshareEsp32TouchLCD3inch5 : public WifiBoard {
private:
    Button boot_button_;
    Button pwr_button_;
    Pmic* pmic_ = nullptr;
    ...
    void InitializeTca9554(void)
    {
        ...
        ret = esp_io_expander_set_level(io_expander, IO_EXPANDER_PIN_NUM_1 | IO_EXPANDER_PIN_NUM_1, 0);
        ESP_ERROR_CHECK(ret);
        vTaskDelay(pdMS_TO_TICKS(100));
...
public:
    WaveshareEsp32TouchLCD3inch5() :
        boot_button_(BOOT_BUTTON_GPIO),pwr_button_(PWR_BUTTON_GPIO, true) {
...
DECLARE_BOARD(WaveshareEsp32TouchLCD3inch5);
