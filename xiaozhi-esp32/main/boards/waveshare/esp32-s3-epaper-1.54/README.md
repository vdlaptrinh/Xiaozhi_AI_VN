...
```bash
python ./scripts/build.py --name esp32-s3-epaper-1.54-v1 waveshare/esp32-s3-epaper-1.54
python ./scripts/build.py --name esp32-s3-epaper-1.54-v2 waveshare/esp32-s3-epaper-1.54
```
